...
<html lang="fr">
    <head>
        ...
        <style>
            ...
            .mesThumbnails { cursor: pointer; }
            .figure { position: relative; }
            .figure-caption { position: absolute; bottom: 0; width: 100%; color: white; background-color: rgba(0, 0, 0, 0.5); }
            ...
            <div class="row">                
                <div class="col-sm-9">
                    <figure class="figure">
                        ...
                        <figcaption class="figure-caption"><h3 class="p-3">Mon portfolio : <span id="textCaption">une image de ville 1</span>.</h3></figcaption>
                    </figure>    
                </div>
